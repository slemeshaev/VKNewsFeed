...
final class NewsfeedCodeCell: UITableViewCell {
    ...
    weak var deleagte: NewsfeedCodeCellDelegate?
    ...
    // функция четвертого слояна viewViews
    private func overlayFourthLayerOnBottomViewViews() {
        likesView.addSubview(likesImage)
        likesView.addSubview(likesLabel)
        
        commentsView.addSubview(сommentsImage)
        ...
        helpInFourthLayer(view: commentsView, imageView: сommentsImage, label: commentsLabel)
    ...
    // функция третьего слоя на bottomView
    ...
    // функция третьего слоя на topView
